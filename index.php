...
<html>
	<head>
		...
		<title>JavaScriptTemplate : Built with Processing and Processing.js</title>
		...
		<style type="text/css">
	body {
	  background-color: #000; color: #bbb; line-height: normal;
...
function getProcessingSketchId () { return 'JavaScriptTemplate'; }
</script>
<script src="maxim.js" type="text/javascript"></script>
	...
	<body>
		<div id="content">
			<div>
				<canvas id="JavaScriptTemplate" data-processing-sources="JavaScriptTemplate.pde" 
